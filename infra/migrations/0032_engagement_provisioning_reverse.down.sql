-- Inversul corectat al lui 0032_engagement_provisioning.up.sql — ADR-043, `OD-64`.
--
-- Inlocuieste `0032_engagement_provisioning.down.sql`, care NU rulează: functiile din schema `rls` sunt
