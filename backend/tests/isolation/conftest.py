...
SEEDED_TABLES = (
    ...
    # The document layer. Children before the header they hang off: the type
    # tables and the positions all point at `document`, and `reversal_document`
    # points at it twice -- once as itself, once as the document it undoes.
    "sales_document",
    "proforma_document",
    "customer_order",
    "purchase_document",
