...
| **C4** | **Structura declarației IPC** (Anexa nr. 1 la Ordinul MF nr. 94/2020), **clasificatorul categoriilor** (Anexa nr. 3) și **lista validărilor** (Anexa nr. 4) | pasul 4 — **numai randarea și depunerea** | **Da, și s-a dovedit** | **Făcut la pasul 4:** darea de seamă există ca entitate — antet înghețat, totaluri pe cod de sursă și rând de tarif, secțiune nominală, versionare (art. 188), reconciliere în ambele sensuri. Coloana categoriei rămâne **goală**, nu ghicită. Formularul tipizat **nu se randează**, iar ecranul spune asta. `OD-108` |
| **C5** | **Structura declarației TVA** (boxele) — identitățile MO obținute, textele nu (`F2.X2 (c)`) | pasul 6 | **Parțial**, ca C4 | Registrele de vânzări și cumpărări întregi, cu toate sumele pe care declarația le cere; formularul, când textul e citit. **Făcut la pasul 6 (02.09, ADR-089, ADR-090):** registrele pe perioada fiscală, pe regimuri, egale cu registrul contabil, cu ecran și export — **nu** în forma prescrisă a art. 118, care e tot text necitit; declarația așteaptă textul |
...
| ~~**C12**~~ *(închisă 03.09: `labour.minimum_wage_monthly` = 6300 din HG 771/2025, citit din proiectul redactat, `provisional`; `salariul-minim-2026.md`)* | **Salariul minim garantat în sectorul real** (`labour.minimum_wage_monthly`) — parametru **inexistent**, nu doar fără margine. Art. 22 alin. (1) cere ca baza CAS să nu fie sub el, proporţional timpului lucrat | pasul 3 — **linia CAS**, pe contract de muncă şi raport de serviciu | **Da**, şi aşa se comportă azi | Linia CAS iese **fără sumă**, cu motivul scris: *„art. 22 cere baza minimă, iar salariul minim nu se rezolvă la această dată"*. Brutul, CNAM şi impozitul se calculează normal. Rularea **nu se poate aproba** — ceea ce e corect, nu un blocaj |
