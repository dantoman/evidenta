...
Se decid la momentul lor. `OD-04` *(înainte de F2)*, `OD-05` *(după F3)*, `OD-31`, `DN-18`, `DN-19`, `DN-21`, `DN-23`, `DN-24`, `DN-25`, `OD-43` *(cât `audit_event` e goală în producție)*, `OD-44` și `OD-45` *(confirmări de contract, suita e verde cu ele)*, `OD-46` *(gardianul pe `*_key`)*, `OD-47` *(privilegiile implicite)*, `OD-54` *(vizibilitatea nominală; are nevoie de `OD-51` întâi)*.
