...
| [071](071-tipurile-de-raport-ca-tabela.md) | Tipurile de raport de muncă sunt tabelă de referință globală; domeniul invariantului e cheie străină spre ea, cu exact două valori și fără „general" | **Propus** — domeniu + excepție `R1`; tabela nu se construiește până la `Acceptat` | 2026-08-30 | `C1(b)` |
